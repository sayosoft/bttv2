...
public class MediaController extends FrameLayout {
    ...
    private OnControllerClick mListener;
    ...
    private void initControllerView(View v) {
        ...
        mShared = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_play_share", "id", mContext.getPackageName()));
        ...
        volumeControl = (SeekBar) v.findViewById(getResources().getIdentifier("volume_bar", "id", mContext.getPackageName()));
        if (mProgress != null) {
    ...
    public void setOnControllerClick(OnControllerClick l) {
        mListener = l;
    }
