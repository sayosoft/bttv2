...
public class VideosActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_movies) {
            ...
            Intent intent = new Intent(VideosActivity.this, PlaylistinnerActivity.class);
            intent.putExtra("pid", 2);
            intent.putExtra("title", "Favorites");
            startActivity(intent);
        } else if (id == R.id.nav_playlist) {
            Intent intent = new Intent(VideosActivity.this, NewPlaylistActivity.class);
...
// Showing progress loading dialog
            proDialog = new ProgressDialog(VideosActivity.this);
