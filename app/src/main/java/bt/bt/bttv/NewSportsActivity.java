...
public class NewSportsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_movies) {
            ...
            Intent intent = new Intent(NewSportsActivity.this, PlaylistinnerActivity.class);
            intent.putExtra("pid", 2);
            intent.putExtra("title", "Favorites");
            startActivity(intent);
        } else if (id == R.id.nav_playlist) {
            Intent intent = new Intent(NewSportsActivity.this, NewPlaylistActivity.class);
            ...
            Intent intent = new Intent(NewSportsActivity.this, WebViewActivity.class);
