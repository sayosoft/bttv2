...
public class HomeActivity extends AppCompatActivity
    ...
    private static final String TAG_VIDEO_TVSHOW_ID = "video_tvshow_id";
    ...
    private void addImagesToThegallery(JSONArray imgs) throws JSONException {
        ...
        for (int i = 0; i < imgs.length(); i++) {
            ...
            String c_tv = m.getString(TAG_VIDEO_TVSHOW_ID);
            ...
            if (c_poster != null && c_id != null) {
                ...
                if (imageGallery != null && c_category == "2" && j < 12) {
                    //Action
                ...
                if (imageGallery2 != null && c_tv != "0" && k <= 12) {
                    //Comedy
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_movies) {
            ...
            Intent intent = new Intent(HomeActivity.this, PlaylistinnerActivity.class);
            intent.putExtra("pid", 2);
            intent.putExtra("title", "Favorites");
            startActivity(intent);
        } else if (id == R.id.nav_playlist) {
            Intent intent = new Intent(HomeActivity.this, NewPlaylistActivity.class);
