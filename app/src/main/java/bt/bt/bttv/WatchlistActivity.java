...
// adding student to students list
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(WatchlistActivity.this, LoginActivity.class);
...
// Showing progress loading dialog
            proDialog = new ProgressDialog(WatchlistActivity.this);
            ...
            loading = Ion.with(context)
                    ...
                    .setCallback(new FutureCallback<JsonArray>() {
                        ...
                        public void onCompleted(Exception e, JsonArray result) {
                            ...
                            if (e != null) {
                                Toast.makeText(WatchlistActivity.this, "Error loading play history", Toast.LENGTH_LONG).show();
                                return;
                            }
                            // add the tweets
