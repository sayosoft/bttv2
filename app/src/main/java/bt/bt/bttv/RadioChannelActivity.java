...
public class RadioChannelActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cd.isConnectingToInternet()) {
            new GetRadioChannels().execute();
        } else {
            Toast.makeText(RadioChannelActivity.this, "Internet not available..!", Toast.LENGTH_SHORT).show();
        }

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Radios");
    ...
    private class GetRadioChannels extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            proDialog = new ProgressDialog(RadioChannelActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            MoviesStr = webreq.makeWebServiceCall(getString(R.string.url_get_radios), WebRequest.GETRequest);
            return null;
        }
        ...
        protected void onPostExecute(Void requestresult) {
            ...
            try {
                ...
                if (jsonObject.getJSONArray("channels") != null) {
                    ...
                    mAdapter = new LiveTvAdapter(RadioChannelActivity.this, liveTvModelList);
